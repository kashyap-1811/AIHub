...
namespace AIHub.API.Migrations
{
    ...
    [Migration("20250920182357_UpdateConversationModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIHub.API.Models.ContextSummary", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ContextSummaries");
                });

            modelBuilder.Entity("AIHub.API.Models.Conversation", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AIHub.API.Models.Message", b =>
                {
                    ...
                    b.HasOne("AIHub.API.Models.Conversation", "Conversation")
                        .WithMany("Messages")
